...
> For database access-control best practices (privileges, RLS, infinite recursion prevention, SECURITY DEFINER, performance), use the **insforge-cli** skill's [db-access-control.md](../../insforge-cli/references/db-access-control.md) reference.
