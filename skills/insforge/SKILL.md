---
name: insforge
description: Integrate InsForge SDK (@insforge/sdk) into frontend applications for database CRUD, authentication flows, file uploads, AI operations, real-time messaging, and edge function invocation. For backend infrastructure operations (creating tables, deploying functions, managing buckets, etc.), use the insforge-cli skill instead.
license: MIT
metadata:
  author: insforge
  version: "1.1.0"
