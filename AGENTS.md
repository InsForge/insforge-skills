...
| Specialized guides such as `db-access-control.md`, storage `postgres-rls.md`, `pgvector.md`, or `s3-gateway.md` | Backend, security, or protocol-specific patterns | When the task needs that capability |
